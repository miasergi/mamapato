        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="border-t border-gray-800 mt-10 pt-6 flex flex-col sm:flex-row justify-between gap-2 text-xs text-gray-500">
            ...
            <div className="flex gap-4 flex-wrap">
              <Link href="/tienda/legal/aviso-legal" className="hover:text-gray-300 transition-colors">Aviso legal</Link>
              <Link href="/tienda/legal/privacidad" className="hover:text-gray-300 transition-colors">Privacidad</Link>
              <Link href="/tienda/legal/cookies" className="hover:text-gray-300 transition-colors">Cookies</Link>
              <Link href="/tienda/legal/envios-devoluciones" className="hover:text-gray-300 transition-colors">Envíos y devoluciones</Link>
            </div>
          </div>
        </div>
      </footer>
