...
const DEMO_CUSTOMERS = [
  { id:'c1',  full_name:'Laura García Pérez',    phone:'612345678', email:'laura.garcia@email.com',  note:'Madre de Emma. Muy pendiente de la lista. Prefiere WhatsApp.',          created_at:'2026-01-10' },
  { id:'c2',  full_name:'Marcos García López',   phone:'612345679', email:null,                      note:'Padre de Emma. Trabaja fuera, contactar por las tardes.',               created_at:'2026-01-10' },
  { id:'c3',  full_name:'Sofía Martínez Ruiz',   phone:'623456789', email:'sofia.m@email.com',       note:'Madre de Oliver. Le interesa mucho el tema del porteo.',               created_at:'2026-01-22' },
  { id:'c4',  full_name:'Pedro Martínez',        phone:'623456790', email:null,                      note:'Padre de Oliver. Reservado, prefiere que gestione todo Sofía.',        created_at:'2026-01-22' },
  { id:'c5',  full_name:'Ana Fernández Bosca',   phone:'634567890', email:'ana.f@email.com',         note:'Lista Lucía ya cerrada. Posible nueva compra para un hermano.',         created_at:'2025-11-05' },
  { id:'c6',  full_name:'Isabel Torres Soler',   phone:'645678901', email:'isabel.t@email.com',      note:'Madre soltera. Muy organizada, casi todo ya comprado.',                 created_at:'2026-02-14' },
  { id:'c7',  full_name:'Carmen López Soler',    phone:'656789012', email:'carmen.lopez@email.com',  note:'Lista en borrador, pendiente de confirmar productos con pareja.',      created_at:'2026-03-01' },
  { id:'c8',  full_name:'Marta Sánchez Gil',     phone:'667890123', email:'marta.s@email.com',       note:'Abuela de Emma García. Muy activa y entusiasta. Viene bastante.',       created_at:'2025-12-20' },
  { id:'c9',  full_name:'Rosa Blanco',           phone:'678901234', email:null,                      note:'Compró trona para regalo. No es madre, es tía de una clienta.',        created_at:'2026-01-30' },
  { id:'c10', full_name:'Javier Torres',         phone:'689012345', email:'javier.t@email.com',      note:'Padre de Hugo. Viaja mucho por trabajo, mejor contactar WhatsApp.',    created_at:'2026-02-14' },
  { id:'c11', full_name:'Roberto López',         phone:'690123456', email:null,                      note:'Padre de Mía. Comparador compulsivo, dale tiempo.',                    created_at:'2026-03-01' },
  { id:'c12', full_name:'Elena Moreno Esteve',   phone:'601234567', email:'elena.moreno@email.com',  note:'Embarazada 7 meses. Lista activa, parto Junio. Muy detallista.',       created_at:'2026-03-20' },
  { id:'c13', full_name:'Alberto Ramos',         phone:'612340001', email:null,                      note:'Cliente frecuente. Tiene 3 hijos, ya sabe lo que quiere.',             created_at:'2025-10-01' },
  { id:'c14', full_name:'Pilar Gómez',           phone:'623451112', email:'pilar.gomez@email.com',   note:'Primer hijo. Muy ilusionada, viene siempre con su madre.',             created_at:'2026-03-28' },
  { id:'c15', full_name:'Lucía Navarro',         phone:'634562223', email:'lucia.n@email.com',       note:'GEMELAS. Necesita el doble de todo. Lista especial para gemelos.',     created_at:'2026-03-10' },
];

// ── Products (8 con página pública + 7 solo catálogo admin) ────
const DEMO_PRODUCTS = [
  { id:'p1',  sku:'BB-001', name:'Cochecito Bugaboo Fox 5',           price:1299, stock_web:1,  stock_store:2,  status:'active',        category:'Movilidad',      slug:'cochecito-bugaboo-fox-5-p1',          iconName:'cart',     description:'El cochecito más versátil de Bugaboo. Suspensión activa, chasis XL y acabados premium.' },
  { id:'p2',  sku:'BB-002', name:'Silla coche Maxi-Cosi Pearl 360',   price:449,  stock_web:3,  stock_store:5,  status:'active',        category:'Seguridad vial', slug:'silla-coche-maxi-cosi-pearl-360-p2',  iconName:'car',      description:'Silla giratoria 360° con tecnología i-Size. Instalación ISOFIX. De 0 a 4 años.' },
  { id:'p3',  sku:'BB-003', name:'Trona Stokke Tripp Trapp',          price:329,  stock_web:0,  stock_store:1,  status:'pending_order', category:'Alimentación',   slug:'trona-stokke-tripp-trapp-p3',         iconName:'utensils', description:'La trona que crece con tu hijo. Diseño escandinavo icónico.' },
  { id:'p4',  sku:'BB-004', name:'Monitor BabyPhone Philips Avent',   price:99,   stock_web:5,  stock_store:8,  status:'active',        category:'Vigilancia',     slug:'monitor-babyphone-philips-avent-p4',  iconName:'camera',   description:'Monitor DECT con visión nocturna y comunicación bidireccional.' },
  { id:'p5',  sku:'BB-005', name:'Mochila portabebés Ergobaby Omni',  price:189,  stock_web:1,  stock_store:0,  status:'active',        category:'Porteo',         slug:'mochila-portabebes-ergobaby-omni-p5', iconName:'backpack', description:'Portabebés ergonómico con 4 posiciones. Recién nacido a 20 kg.' },
  { id:'p6',  sku:'BB-006', name:'Cuna colecho Chicco Next2Me',       price:279,  stock_web:2,  stock_store:3,  status:'active',        category:'Descanso',       slug:'cuna-colecho-chicco-next2me-p6',      iconName:'bed',      description:'Cuna de colecho que se acopla a la cama de los padres.' },
  { id:'p7',  sku:'BB-007', name:'Bañera plegable Stokke Flexi Bath', price:89,   stock_web:2,  stock_store:4,  status:'active',        category:'Baño',           slug:'banera-plegable-stokke-flexi-bath-p7',iconName:'droplet',  description:'Bañera plegable y ligera. Reductor recién nacido incluido.' },
  { id:'p8',  sku:'BB-008', name:'Sacaleches eléctrico Medela Swing', price:149,  stock_web:1,  stock_store:2,  status:'active',        category:'Lactancia',      slug:'sacaleches-electrico-medela-swing-p8',iconName:'bottle',   description:'Sacaleches compacto tecnología 2-Phase Expression. Silencioso.' },
  { id:'p9',  sku:'BB-009', name:'Hamaca BabyBjörn Bliss',            price:249,  stock_web:0,  stock_store:0,  status:'inactive',      category:'Descanso',       slug:'hamaca-babybjorn-bliss-p9',           iconName:'bed',      description:'Hamaca reclinable en 3 posiciones. Materiales sostenibles.' },
  { id:'p10', sku:'BB-010', name:'Chupetes Philips Avent pack 4u',    price:19,   stock_web:12, stock_store:20, status:'active',        category:'Lactancia',      slug:'chupetes-philips-avent-p10',          iconName:'droplet',  description:'Pack 4 chupetes talla 1. Forma simétrica ultra-suave.' },
  { id:'p11', sku:'BB-011', name:'Saco dormir Ergobaby 0-6m',         price:59,   stock_web:4,  stock_store:6,  status:'active',        category:'Descanso',       slug:'saco-dormir-ergobaby-p11',            iconName:'bed',      description:'Saco de dormir tog 2.5. Algodón orgánico certificado.' },
  { id:'p12', sku:'BB-012', name:'Termómetro digital Braun',          price:45,   stock_web:8,  stock_store:10, status:'active',        category:'Salud',          slug:'termometro-braun-p12',                iconName:'droplet',  description:'Termómetro de oído Age Precision. Resultado en 1 segundo.' },
  { id:'p13', sku:'BB-013', name:'Colchón cuna 60x120 Micuna',        price:129,  stock_web:1,  stock_store:2,  status:'active',        category:'Descanso',       slug:'colchon-cuna-micuna-p13',             iconName:'bed',      description:'Colchón cuna 60x120, núcleo HR. Funda extraíble lavable.' },
  { id:'p14', sku:'BB-014', name:'Bañera Thermobaby 2 en 1',          price:39,   stock_web:3,  stock_store:5,  status:'active',        category:'Baño',           slug:'banera-thermobaby-p14',               iconName:'droplet',  description:'Bañera 2 en 1 con asiento de baño. Termómetro integrado.' },
  { id:'p15', sku:'BB-015', name:'Carro gemelar Joie Finiti',         price:799,  stock_web:0,  stock_store:1,  status:'inactive',      category:'Movilidad',      slug:'carro-gemelar-joie-finiti-p15',       iconName:'cart',     description:'Carro gemelar en tándem. Convierte en silleta individual.' },
];
...
function statusLabel(s) {
  return { active:'Activo', pending_order:'Pedido pendiente', inactive:'Inactivo' }[s] || s;
}
function statusClass(s) {
  return { active:'bg-green-100 text-green-800', pending_order:'bg-amber-100 text-amber-800', inactive:'bg-gray-100 text-gray-600' }[s] || 'bg-gray-100 text-gray-600';
}
